 ...
 */
final class Version20190309151016 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_AF86866F89BC6E01');
        $this->addSql('DROP INDEX uuid_offre_idx');
        $this->addSql('CREATE TEMPORARY TABLE __temp__offre AS SELECT id, aire_id, uuid, nom, commerce, code_ean, description FROM offre');
        $this->addSql('DROP TABLE offre');
        $this->addSql('CREATE TABLE offre (id INTEGER NOT NULL, aire_id INTEGER NOT NULL, uuid CHAR(36) NOT NULL COLLATE BINARY --(DC2Type:guid)
        , nom VARCHAR(255) NOT NULL COLLATE BINARY, commerce VARCHAR(255) NOT NULL COLLATE BINARY, code_ean VARCHAR(20) NOT NULL COLLATE BINARY, description VARCHAR(255) NOT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_AF86866F89BC6E01 FOREIGN KEY (aire_id) REFERENCES aire (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO offre (id, aire_id, uuid, nom, commerce, code_ean, description) SELECT id, aire_id, uuid, nom, commerce, code_ean, description FROM __temp__offre');
        $this->addSql('DROP TABLE __temp__offre');
        $this->addSql('CREATE INDEX IDX_AF86866F89BC6E01 ON offre (aire_id)');
        $this->addSql('CREATE UNIQUE INDEX uuid_offre_idx ON offre (uuid)');
        ...
        , numserie VARCHAR(20) NOT NULL COLLATE BINARY, data VARCHAR(255) NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_389B78389BC6E01 FOREIGN KEY (aire_id) REFERENCES aire (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__offre AS SELECT id, aire_id, uuid, nom, commerce, code_ean, description FROM offre');
        $this->addSql('DROP TABLE offre');
        $this->addSql('CREATE TABLE offre (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, aire_id INTEGER NOT NULL, uuid CHAR(36) NOT NULL --(DC2Type:guid)
        , nom VARCHAR(255) NOT NULL, commerce VARCHAR(255) NOT NULL, code_ean VARCHAR(20) NOT NULL, description VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO offre (id, aire_id, uuid, nom, commerce, code_ean, description) SELECT id, aire_id, uuid, nom, commerce, code_ean, description FROM __temp__offre');
        $this->addSql('DROP TABLE __temp__offre');
        $this->addSql('CREATE INDEX IDX_AF86866F89BC6E01 ON offre (aire_id)');
        $this->addSql('CREATE UNIQUE INDEX uuid_offre_idx ON offre (uuid)');
        ...
        , numserie VARCHAR(20) NOT NULL, data BLOB NOT NULL)');
        $this->addSql('INSERT INTO tag (id, aire_id, uuid, data, numserie) SELECT id, aire_id, uuid, data, numserie FROM __temp__tag');
        $this->addSql('DROP TABLE __temp__tag');
        $this->addSql('CREATE INDEX IDX_389B78389BC6E01 ON tag (aire_id)');
        $this->addSql('CREATE UNIQUE INDEX uuid_tag_idx ON tag (uuid)');
